...
// ========================================================================
// ------------------------------------------------------------------------
namespace MasterAutomationFramework.T4GenericTemplates.Pages.Google
{
	...
	public abstract class GooglePageBy : WebPageBase
	{
        ...
        public override Dictionary<string, By> Selectors
        {
            get
            {
                ...
                {
                    elementsSelectors = GetByReflector.GetAllElementLocators(typeof(GooglePage));
                }
